...
## 5. Tám chức năng cốt lõi — bắt buộc phải có ở MVP

| # | Chức năng | Lý do bắt buộc |
|---|-----------|----------------|
| 1 | Quản lý sản phẩm | Không có sản phẩm thì không có gì để bán |
| 2 | Giỏ hàng & Thanh toán | Dòng tiền chính của toàn hệ thống |
| 3 | Quản lý đơn hàng | Xử lý nghiệp vụ sau khi mua |
| 4 | Quản lý kho | Tránh bán hàng không có sẵn |
| 5 | Tích hợp vận chuyển | Giao hàng đến tay khách |
| 6 | Tìm kiếm & Lọc sản phẩm | Khách cần tìm được thứ muốn mua |
| 7 | Đánh giá khách hàng | Xây dựng uy tín và trust |
| 8 | Báo cáo doanh thu | Theo dõi hiệu quả kinh doanh |
...
*Xem kế hoạch triển khai chi tiết tại: [mvp-plan.md](./mvp-plan.md)*
